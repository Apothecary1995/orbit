...
func (c *authServiceClient) EnableTOTP(ctx context.Context, in *TOTPRequest, opts ...grpc.CallOption) (*TOTPResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TOTPResponse)
...
func (UnimplementedAuthServiceServer) EnableTOTP(context.Context, *TOTPRequest) (*TOTPResponse, error) {
...
func _AuthService_EnableTOTP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).EnableTOTP(ctx, req.(*TOTPRequest))
	}
	return interceptor(ctx, in, info, handler)
}
